...
async function main(){
    ...
    // Prueba metodo save()
    let newProduct1 = {"id":15, "name":"Camiseta titular Real Madrid", "price": 1800, "src":"/resources/img/product-images/bombachita1.jpg"} // Prueba con un producto que ya posee id
    await products.save(newProduct1)
    let newProduct2 = {"name":"Guantes Arquero", "price": 800, "src":"https://static.dafiti.com.ar/p/reusch-0073-243945-1-product.jpg"} // Prueba con un producto sin id
